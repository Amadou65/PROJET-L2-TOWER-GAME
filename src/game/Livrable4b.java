...
public class Livrable4b extends Livrable4 {
    ...
    public static void main(String[] args)  throws TooLongPathException, NegativeValueException, ZeroValueException {
        ...
        if(height <= 0 || width <= 0 || nbChemins <= 0) {
            ...
            throw new NegativeValueException("Erreur : tous les arguments doivent être strictement positifs.");
        }
        if(nbChemins > height) {
            ...
            throw new TooLongPathException("Le nombre des chemin est trop grand");
        }
